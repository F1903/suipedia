...
function initGraphQLTada() {
  ...
  graphql2.scalar = function scalar(r2, n2) {
    return n2;
  };
...
var __privateSet2 = (obj, member, value2, setter) => (__accessCheck3(obj, member, "write to private field"), setter ? setter.call(obj, value2) : member.set(obj, value2), value2);
...
var __privateAdd2 = (obj, member, value2) => member.has(obj) ? __typeError4("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value2);
...
var StashedPopup = class {
  constructor({
    ...
    __privateAdd2(this, _listener, (event) => {
      ...
      if (!success || output.id !== __privateGet5(this, _id)) return;
      ...
      if (output.payload.type === "reject") {
        ...
        __privateGet5(this, _resolve).call(this, output.payload.data);
      }
    });
    ...
    __privateSet3(this, _name, name2);
  ...
  send({
    ...
    __privateGet5(this, _popup).location.assign(
      `${__privateGet5(this, _origin)}/dapp/${type2}?${new URLSearchParams({
        ...
        network: __privateGet5(this, _network2),
...
var StashedWallet = class {
  constructor({
    ...
    __privateAdd3(this, _signTransactionBlock, async ({ transactionBlock, account }) => {
      ...
      const popup = new StashedPopup({
        ...
        network: __privateGet6(this, _network3)
      });
    ...
    __privateSet4(this, _name2, name2);
  ...
  get chains() {
    return [`sui:${__privateGet6(this, _network3)}`];
  }
  get accounts() {
...
function renderCss(v) {
  ...
  var _loop2 = function _loop22(key2) {
    ...
    if (value2 && Array.isArray(value2)) {
      ...
      if (!isEmpty2) {
        rules.push("".concat(indent).concat(key2, " {\n").concat(renderCss(value2, indent + DOUBLE_SPACE), "\n").concat(indent, "}"));
      }
    } else if (value2 === DECLARATION) {
      rules.push("".concat(indent).concat(key2, ";"));
    } else {
      rules.push("".concat(indent).concat(key2.startsWith("--") ? key2 : dashify(key2), ": ").concat(value2, ";"));
    }
  };
...
function WalletListItem({ name: name2, icon, onClick, isSelected = false }) {
  return (0, import_jsx_runtime13.jsx)("li", { className: container7, children: (0, import_jsx_runtime13.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon && typeof icon === "string" ? (0, import_jsx_runtime13.jsx)("img", { className: walletIcon2, src: icon, alt: `${name2} logo` }) : icon,
