...
export declare function buildSwapPTBFromQuote(userAddress: string, txb: Transaction, minAmountOut: number, coinIn: TransactionResult, quote: Quote, referral?: number, ifPrint?: boolean, // Set ifPrint to be optional with a default value
apiKey?: string, swapOptions?: SwapOptions): Promise<TransactionResult>;
